...
@Component({
  selector: 'app-building-workplace',
  templateUrl: './building-workplace.component.html',
  styleUrls: ['./building-workplace.component.css']
})
export class BuildingWorkplaceComponent implements OnInit {
